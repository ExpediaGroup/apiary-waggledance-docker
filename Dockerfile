...
ARG WAGGLE_DANCE_VERSION=4.1.2-SNAPSHOT
...
RUN wget https://central.sonatype.com/repository/maven-snapshots/com/expediagroup/waggle-dance-rpm/4.1.2-SNAPSHOT/waggle-dance-rpm-4.1.2-20251031.103521-8.rpm -O /tmp/waggle-dance-rpm-4.1.2-20251031.103521-8.rpm
RUN yum install -y /tmp/waggle-dance-rpm-4.1.2-20251031.103521-8.rpm
